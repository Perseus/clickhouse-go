...
import (
	...
	clickhouse_tests "github.com/Perseus/clickhouse-go/v2/tests"
	"github.com/Perseus/clickhouse-go/v2/tests/std"
	clickhouse_std_tests "github.com/Perseus/clickhouse-go/v2/tests/std"
